...
SELECT id, date, court_count, court_fee, shuttle_price, shuttle_count, court_price_rows, shuttle_price_rows, created_at, updated_at FROM booking_sessions ORDER BY date ASC, id ASC;
